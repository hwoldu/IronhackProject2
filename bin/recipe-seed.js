...
const recipeSchema = [
  {
    ...
    "description": [
      ...
      "Put the potatoes in a saucepan of water, bring to the boil and cook for 8 mins.", 
      "Drain and leave to steam dry.",  
      "Put the potatoes in one roasting tin and the radishes into another.", 
      "Divide the oil between them, along with the mustard seeds and chilli flakes.", 
      "Season and give everything a good mix.", 
      "Put in the oven and roast for 25 mins, then take out the radishes and roast the potatoes for an extra 10 mins until crisp.", 
      "Meanwhile, toast the pumpkin seeds in a dry frying pan.",  
      "Spread the yogurt onto a sharing platter.", 
      "Pile on the potatoes and radishes, then scatter over the spring onions, pumpkin seeds and a few more chilli flakes, if you like."
    ],
    "image": "",
    "duration": 60,
    "season": "summer"
  },
  {
    ...
    "dishType": "dessert",
    "description": [
      "Put a sundae glass or bowl in the freezer to chill.", 
      "To make the sauce, put the raspberries, sugar and lime juice in a blender, and blitz to a purée, loosening with a splash of water if necessary.", 
      "Set aside.", 
      "Meanwhile, whip the cream with the vanilla and icing sugar until it holds its shape, then transfer to a piping bag fitted with a star-shaped nozzle, if you like.", 
      "Pour the champagne or prosecco (if using) into the chilled glass, then neatly layer balls of ice cream, peach wedges, raspberries, raspberry sauce and cream, finishing with a big swirl of cream on the top.", 
      "Scatter with the toasted almonds and serve straight away with two spoons.",
    ],
    "image": "",
    "duration": 60,
    "season": "summer"
  ...
  },
  {
    ...
    "description": [
      ...
      "Tip into a large roasting tin then roast for 30 mins.", 
      "Add the tomatoes to the pan and return to the oven for 10 mins.",
  ...
  },
  {
    ...
    "description": [
      ...
      "Roast for 40-45 mins until soft and starting to caramelise at the edges, stirring occasionally.", 
      "Meanwhile, fry the onions in 1 tbsp olive oil until soft, then add the garlic, chicken stock, cinnamon and nutmeg.", 
      ...
      "To make the lemon & garlic toasts, gently warm the olive oil and garlic in a pan over a low heat for a few mins; the garlic should be softened but not browned.", 
  ...
  },
  {
    ...
    "description": [
      ...
      "When it foams, add 450g potatoes, cut into 1cm cubes, 1 small onion, cut the same as the potatoes, and 450g white parts of leeks, sliced and toss them in the butter until they are well coated.",  
      "Season well with salt and freshly ground pepper and toss again.", 
      "Put a disc of greaseproof paper (called a cartouche by chefs) on top of the vegetables to keep in the steam), then cover the pan with its lid.",  
      "Cook over a gentle heat for 10 mins, or until the vegetables are soft but not coloured.", 
      "Uncover the pan and discard the paper.", 
      "Pour in 850ml of the light chicken or vegetable stock, bring to the boil and simmer until the vegetables are just cooked – about 5 minutes.", 
  ...
  },
  {
    ...
    "dishType": "main dish",
    "description": [
      "Soak the rice in water for 1 hr, then rinse in a sieve until the water runs clear.", 
      "Heat oven to 200C/180C fan/gas 6.", 
      "Bring a large saucepan of water to the boil with the stock cube in it.", 
      "Add the rice and lentils, and simmer for 5 mins until just beginning to soften on the outside. Drain well.",  
      "Toss the chunky parsnips with 2 tbsp of the oil, the orange zest, 1 tsp of the cumin seeds and plenty of seasoning in a roasting tin.", 
      "Roast for 30 mins until golden, then drizzle with honey and roast for 5-10 mins more.",  
      "Meanwhile, heat 1 tbsp of the oil in a wide flameproof casserole or deep pan.", 
      "Fry the onions until softened and browned.", 
      "Stir in the remaining cumin with the rest of the spices and cook for 1 min, then add the grated parsnips and raisins, and cook for 1 min more.", 
      "Turn the heat right down and stir in the rice mixture with plenty of seasoning.",  
      "Melt the butter and remaining 1 tbsp oil in the big saucepan you cooked the rice in.", 
      "Tip in the rice mixture and roughly flatten the surface.", 
      "Poke 3 steam holes in the rice with the handle of a wooden spoon.", 
      "Cover the pan with a tea towel, then put on the lid.", 
      "Cook for 20-25 mins more, making sure the heat stays quite low.",  
      "To make the herb sauce, whizz all the ingredients to a salsa-like mix.", 
      "Spread the rice on a serving platter, breaking up any crispy chunks from the bottom.", 
      "Top with the roasted parsnips and herb sauce, and serve with some yogurt, if you like.",
    ],
  ...
  },
  {
    ...
    "description": [
      ...
      "Put the chopped apples, lemon zest, rosemary, if using, and sugar in a saucepan.", 
      "Add the lemon juice and cook for 3-4 mins.", 
      "Tip in the pears and cook 2-3 mins more, until the fruits are just beginning to soften.", 
      "Spoon the fruits and juices into a 1.7 litre pudding dish and flatten slightly.",  
      "For the crumble, finely chop half the walnuts in a food processor until reduced to the consistency of ground almonds.", 
      "Add the flour, butter and sugar and continue to blitz to a coarse or fine crumble mix, whichever you prefer.",  
      "Roughly break the remaining walnuts with your fingers and stir into the crumble.", 
      "Scatter the crumble mix on top of the fruits and bake for 20-25 mins until golden brown.", 
  ...
  },
  {
    ...
    "description": [
      ...
      "Toss the pumpkin (or squash) in a little oil on a baking tray.", 
      "Roast until soft enough to squash with the back of a fork – this can take between 40 mins and 1 hr, depending on the type of pumpkin or squash you use.", 
      "Set aside to cool.", 
      "Meanwhile, on a lightly floured work surface, roll out the pastry to the thickness of a £1 coin.", 
      "Drape it over your rolling pin and lift into a 23cm fluted tart tin.", 
      "Push the pastry into the corners of the tin using a scrap of excess pastry (you’re less likely to pierce the pastry this way than using a finger).", 
      "Trim the excess pastry, leaving about 1cm hanging over the edge of the tin; it will shrink as it cooks.", 
      "Chill for 20 mins.",  
      "Increase the oven to 200C/180C fan/gas 6.", 
      "Line the tart case with a sheet of baking parchment (scrunch it up first to make it more pliable), then fill with baking beans or dry rice.", 
      "Bake for 15 mins until the sides look golden, then remove the parchment and filling.", 
      "Bake for another 5-10 mins until the base looks biscuity and dry.", 
      "Trim the edges with a small, serrated knife.", 
      "Tip the roasted pumpkin (or squash), maple syrup, sugar, salt, spices, cornflour and milk into a food processor or blender and blitz until smooth.", 
      "Pour through a sieve into a small pan and cook for 5 mins, stirring continuously, until thickened.", 
      "Fill the tart case with the pumpkin filling, then return to the oven and lower the heat to 180C/160C fan/gas 4.", 
      "Bake for 30 mins until the filling is set when you wobble the tart tin.", 
      "Cool for 20-25 mins.", 
      "Dust with icing sugar and serve warm, or chill and serve within two days.",
    ],
  ...
  },
  {
    ...
    "description": [
      ...
      "Throw in the vinegar and nestle the salmon amongst the vegetables.", 
    ...
    "image": "/images/spring/recipes/onepan-salmon-asparagus.jpg",
    "duration": 20,
    "season": "spring"
  },
  {
    ...
    "description": [
      ...
      "Toss the squash in 1 tbsp oil together with the chopped sage.", 
      ...
      "Add the stock, a ladleful at a time and stirring the rice over a low heat for 25-30 mins, until the rice is cooked al dente (with a slightly firm, starchy bite in the middle).", 
...

  {
    ...
    "description": [
      ...
      "Place the squash on a baking tray and toss with olive oil.", 
      "Roast for 20 mins.", 
      ...
      "Boil the broccoli in salted water until just tender, then drain and rinse in cold water.", 
      "Drain and pat dry.", 
...

  {
    ...
    "description": [
      "Heat oven to 200c/fan 180c/gas 6.", 
      "Toss the bread with the olive oil in a small roasting tin.", 
      "Season with salt and pepper, spread out over a single layer, then bake for 12-15 mins until the bread is browned and crisp.", 
      "Tip onto a plate lined with kitchen paper, then leave to cool.", 
      "For the dressing, mix the onion with the vinegar in a small bowl, then leave for 10 mins.", 
      "Combine the mustard and oil, season with salt and pepper, then whisk until slightly thickened.", 
      "Stir into the onions, then set aside.", 
      "Tip the lettuce into a large bowl.", 
      "Add the chestnuts to the bowl with the beetroot.", 
      "Heat a non-stick pan, add the ham, then fry quickly on each side until crisp.", 
      "Just before serving, thinly slice the apple, then add to the bowl with the croutons.", 
      "Add the dressing, then toss everything together until glistening.", 
